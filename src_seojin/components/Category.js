...
const Category = ({ item, deleteCategory, updateCategory, newCategory, setNewCategory, categories, setCategories, selectAll, deleteAll }) => {
    ...
    return isEditing ? (
        ...
        <View>
            ...
            <View style={categoryStyle.container}>
                ...
                <BoxButton label = "Select" onPressOut = {selectAll}/>
                <BoxButton label = "Delete" onPressOut = {deleteAll}/>
            </View>
